public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        QuantityLength result = foot.add(inch, LengthUnit.YARD);
        System.out.println("1 Foot + 12 Inches in Yards = " + result);

        QuantityLength yard = new QuantityLength(1.0, LengthUnit.YARD);
        QuantityLength cm = new QuantityLength(91.44, LengthUnit.CM);
        QuantityLength result2 = yard.add(cm, LengthUnit.FEET);
        System.out.println("1 Yard + 91.44 Cm in Feet = " + result2);

        QuantityLength inch2 = new QuantityLength(6.0, LengthUnit.INCH);
        QuantityLength cm2 = new QuantityLength(2.54, LengthUnit.CM);
        QuantityLength result3 = inch2.add(cm2, LengthUnit.INCH);
